...
inventorNamedAda = inventors.find(
  (inventor) => {
  return inventor.first === 'Ada'
})

// Check your return value:c 
...
// Enter your solution code here:
isAdultPresent = inventors.some(
  (inventor) => {
    return 2024 - inventor.year >= 18
  })
...
// Enter your solution code here:
isEveryone19OrOlder = people.every(
  (person) => {
